...
""",
    ...
    result = runner.run_builder(script_dir, {}, datetime(2024, 1, 1), env_file=None)
...
""",
    ...
    with pytest.raises(RuntimeError, match="something went wrong"):
        runner.run_builder(script_dir, {}, datetime(2024, 1, 1), env_file=None)
...
""",
    ...
    result = runner.run_builder(script_dir, {}, datetime(2024, 1, 1), env_file=env_file)
...
""",
    ...
    runner.run_builder(script_dir, {}, datetime(2024, 1, 1), env_file=env_file)
